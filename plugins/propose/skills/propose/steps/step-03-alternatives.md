...
- 🛑 NEVER invent an alternative to reach a count: a padded option nobody
  would pick is worse than two honest ones
- ✅ ALWAYS include "do nothing / status quo" as alternative 0
- ✅ ALWAYS write every option that is genuinely on the table, however many
...
- Variables: `{proposal_path}`, `{auto_mode}`, `problem_summary`, `context_collected`
- Output: section 5 of PROPOSAL.md
...
**References:** {url, decision record-NNNN}
...
❌ No reversibility note: biggest gap in junior proposals

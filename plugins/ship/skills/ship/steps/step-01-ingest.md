# Read an approved specification

Brief: read brief.md status ready, acceptance criteria and tasks.md.
Proposal: read PROPOSAL.md status Accepted, design and section 10 tasks.
...
a substitute for reading effects such as install/deploy.
